...
def handler(request, context):
    try:
        ...
        if env_aws_default_region is None:
            print("ERROR skill.index.handler.aws_default_region is None default to eu-west-1")
            env_aws_default_region = 'eu-west-1'
        ...
        if env_api_id is None:
            print("ERROR skill.index.handler.env_api_key is None")
            return '{}'
